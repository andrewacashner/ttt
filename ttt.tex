...
\X11:Populate switching tables\X\6
${}\\{printf}(\.{"\%s\\n"},\39\\{greeting});{}$\6
\X12:Draw board\X\6
\&{while} ${}(\\{gameover}\E\.{FALSE}){}$\5
${}\{{}$\1\6
\X4:Get O move, update board\X\6
\X15:Process last move\X\6
\X21:Prepare next move\X\6
\4${}\}{}$\2\6
\X28:Gameover routine\X\6
\&{return} (\T{0});\6
\4${}\}{}$\2\par
\fi
...
\M{8}Switching table with winning series.
...
\M{9}These are all the triples that win the game.
...
\M{10}Switching tables created in \PB{\\{main}}.
\fi

\M{11}Set up switching table of permutations.
\Y\B\4\X11:Populate switching tables\X${}\E{}$\par
\U1.\fi

\M{12}Draw the board. We simply print \PB{\\{charboard}} to \PB{\\{stdout}}.

\Y\B\4\X12:Draw board\X${}\E{}$\6
$\\{printf}(\.{"\%s"},\39\\{charboard}){}$;\par
\Us1\ET14.\fi

\N{1}{13}Updating the game board.

\Y\B\4\X13:Function prototypes\X${}\E{}$\6
\&{int} \\{newmove}(\&{int} \\{player}${},\39{}$\&{int} \\{square}${},\39{}$%
\&{int} ${}{*}\\{gameboard},\39{}$\&{char} ${}{*}\\{charboard}){}$;\par
\A23.
\U1.\fi

\M{14}The function updates the gameboard with a new move.
...
\M{15}Process the X and O moves of turn just completed.

\Y\B\4\X15:Process last move\X${}\E{}$\6
\X16:Test for win 3/3\X\6
\X17:Update X positions\X\6
\X18:Update O positions\X\6
\X19:Eliminate X wins\X\6
\X20:Eliminate O wins\X\par
\U1.\fi

\M{16}TODO
\Y\B\4\X16:Test for win 3/3\X${}\E{}$\C{ Test X values for 3/3 }\C{ Test O
values for 3/3 }\par
\U15.\fi

\M{17}Update X positions.

\Y\B\4\X17:Update X positions\X${}\E{}$\par
\U15.\fi

\M{18}TODO
\Y\B\4\X18:Update O positions\X${}\E{}$\par
\U15.\fi

\M{19}TODO
\Y\B\4\X19:Eliminate X wins\X${}\E{}$\par
\U15.\fi

\M{20}TODO
\Y\B\4\X20:Eliminate O wins\X${}\E{}$\par
\U15.\fi

\M{21}Prepare the next X move.

\Y\B\4\X21:Prepare next move\X${}\E{}$\6
\X24:Test for X runs 2/3\X\6
\X25:Test for O runs 2/3\X\6
\X27:Choose free spot\X\6
...
\M{22}Test for two in a row, and if found, return the third member.

\fi

\M{23}Function to test two in a row.

\Y\B\4\X13:Function prototypes\X${}\mathrel+\E{}$\6
\&{int} \\{twoofthree}(\&{int} \\{test}[\,]${},\39{}$\&{int} \\{test\_array%
\_length}${},\39{}$\&{int} \\{perms}[\,][\T{3}]);\par
\fi

\M{24}TODO
\Y\B\4\X24:Test for X runs 2/3\X${}\E{}$\par
\U21.\fi

\M{25}TODO
\Y\B\4\X25:Test for O runs 2/3\X${}\E{}$\par
\U21.\fi

\M{26}Move X to any optimal square.
...
\M{27}Loop through list of optimal squares and select one that is not occupied.

\Y\B\4\X27:Choose free spot\X${}\E{}$\6
...
\N{1}{28}Game-over routine.
\Y\B\4\X28:Gameover routine\X${}\E{}$\6
\\{printf}(\.{"Game\ over!\\n"});\par
\U1.\fi
