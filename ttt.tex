...
\X27:Prepare next move\X\6
\4${}\}{}$\2\6
\X36:Gameover routine\X\6
\&{return} (\T{0});\6
\4${}\}{}$\2\par
\fi
...
\X24:Update O positions\X\6
\X25:Eliminate X wins\X\6
\X26:Eliminate O wins\X\par
\U1.\fi

\M{20}TODO
\Y\B\4\X20:Test for win 3/3\X${}\E{}$\6
\\{printf}(\.{"Checking\ for\ O\ win.}\)\.{..\\n"});\6
\&{if} ${}(\\{check\_triple}(\\{listOmoves})\E\.{TRUE}){}$\5
${}\{{}$\1\6
${}\\{bool\_gameover}\K\.{TRUE};{}$\6
${}\\{winner}\K\.{OPLAYER};{}$\6
\4${}\}{}$\C{ Test X values for 3/3 }\C{ Test O values for 3/3 }\2\par
\U19.\fi

\M{21}Function to test player's board positions for winning series, 3 out of 3.
...
\M{22}\B\X7:Function prototypes\X${}\mathrel+\E{}$\6
\&{boolean} \\{check\_triple}(\&{square\_ptr} \\{head});\par
\fi

\M{23}Update X positions.

\Y\B\4\X23:Update X positions\X${}\E{}$\par
\U19.\fi

\M{24}TODO
\Y\B\4\X24:Update O positions\X${}\E{}$\par
\U19.\fi

\M{25}TODO
\Y\B\4\X25:Eliminate X wins\X${}\E{}$\par
\U19.\fi

\M{26}TODO
\Y\B\4\X26:Eliminate O wins\X${}\E{}$\par
\U19.\fi

\M{27}Prepare the next X move.

\Y\B\4\X27:Prepare next move\X${}\E{}$\6
\X30:Test for X runs 2/3\X\6
\X31:Test for O runs 2/3\X\6
\X33:Choose free spot\X\6
...
\M{28}Test for two in a row, and if found, return the third member.

\fi

\M{29}Function to test two in a row.
...
\M{30}TODO
\Y\B\4\X30:Test for X runs 2/3\X${}\E{}$\par
\U27.\fi

\M{31}TODO
\Y\B\4\X31:Test for O runs 2/3\X${}\E{}$\par
\U27.\fi

\M{32}Move X to any optimal square.
...
\M{33}Loop through list of optimal squares and select one that is not occupied.

\Y\B\4\X33:Choose free spot\X${}\E{}$\6
...
\M{34}Print current list of moves (for testing purposes only).
...
\M{35}\B\X7:Function prototypes\X${}\mathrel+\E{}$\6
\&{void} \\{print\_movelist}(\&{square\_ptr} \\{list});\par
\fi

\N{1}{36}Game-over routine.

\Y\B\4\X36:Gameover routine\X${}\E{}$\6
\\{printf}(\.{"\\n***\ Game\ over!\ **}\)\.{*\\n"});\6
\&{if} ${}(\\{winner}\E\.{EMPTY}){}$\5
${}\{{}$\1\6
\\{printf}(\.{"***\ \ \ DRAW.\ \ \ \ ***\\}\)\.{n"});\6
